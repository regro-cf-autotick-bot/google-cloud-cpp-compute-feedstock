About google-cloud-cpp-compute-feedstock
========================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/google-cloud-cpp-compute-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-cloud-cpp-compute-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libgoogle-cloud-compute libgoogle-cloud-compute-devel
# for installing globally
pixi global install libgoogle-cloud-compute libgoogle-cloud-compute-devel
```
...
It is possible to list all of the versions of `libgoogle-cloud-compute` available on your platform:
...
```
pixi search libgoogle-cloud-compute --channel conda-forge
```
